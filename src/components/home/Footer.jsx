...
// import tdlogo2 from "../images/tdlogo.png"
...
export default function Footer() {
    ...
    return (
        <div></div>
        // {/* <footer
        //     className="bg-slate-950 text-center text-slate-300  lg:text-left relative ">
        ...
        //     <div className="w-full border-b border-fuchsia-600 border-opacity-50 sm:flex justify-center items-center xl:gap-60 xl:py-10">
        ...
        //             <div className=" hidden xl:block xl:font-bold xl:text-2xl text-white  text-center">
        ...
        //     <div className=" py-10 text-center md:text-left relative z-50 border-b border-fuchsia-600 border-opacity-50">
        //         <div className="grid-1 mx-6 grid gap-8 md:grid-cols-2 sm:px-10 sm:mx-auto lg:grid-cols-3 lg:px-24">



        //             <div className="flex flex-col sm:gap-1 text-3xl">
        //                 <h6
        ...
        //                     </svg>
        //                     <span className="text-3xl">nail.instructor@tinadobre.ro</span>
        //                 </div>
        //                 <p className="text-2xl cursor-pointer mb-4 flex justify-center gap-3 text-center w-full items-center sm:justify-start" onClick={handleWhatsAppButtonClick}><WhatsAppOutlined className="" /><span className="text-3xl mt-1">Whatsapp message</span></p>
        ...
        //                             clipRule="evenodd" />
        //                     </svg>
        //                     <span className="text-3xl">0769896988</span>
        ...
        //     <div className="bg-slate-950 p-6 text-center flex flex-col sm:flex-row sm:gap-4 justify-center relative z-50 text-2xl">
